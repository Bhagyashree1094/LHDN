...
variable "resource_group_name_nprod" {
  type        = string
  description = "(Required) Name of the Resource Group in which to create the virtual network."
}
...
variable "resource_group_name_security" {
  type        = string
  description = "(Required) Name of the Resource Group in which to create the virtual network."
}
...
variable "virtual_network_name_prod" {
  type        = string
  description = "(Required) Name of the Virtual Network for prod hub in which connection need to be established.."
}

variable "virtual_network_name_prod_1" {
  type        = string
  description = "(Required) Name of the Virtual Network for prod hub in which connection need to be established.."
}


variable "virtual_network_name_nprod" {
  type        = string
  description = "(Required) Name of the Virtual Network for non prod hub in which connection need to be established.."
}

variable "virtual_network_name_nprod_2" {
  type        = string
  description = "(Required) Name of the Virtual Network for non prod hub in which connection need to be established.."
}

variable "virtual_network_name_build" {
  type        = string
  description = "(Required) Name of the Virtual Network for build in which connection need to be established.."
}

variable "virtual_network_name_mgmt" {
  type        = string
  description = "(Required) Name of the Virtual Network in which connection need to be established.."
}

variable "virtual_network_name_identity" {
  type        = string
  description = "(Required) Name of the Virtual Network in which connection need to be established.."
}

variable "virtual_network_name_security" {
  type        = string
  description = "(Required) Name of the Virtual Network in which connection need to be established.."
}
#------------------------------
...
variable "address_prefix_hub" {
  type        = string
  description = "(Required) the Address Prefix which should be used for this Virtual Hub and `basic`. Defaults to `Standard`."
}
...
variable "vpn_scale_unit" {
  type        = number
  description = "(Optional)The Scale unit of VPN."
  default     = "8"
  
}

variable "vpn_address_cidrs" {
  type        = list(string)
  description = "(Optional)The SKU of the Virtual Hub. Possible values are Basic and Standard`."
}
variable "vpn_link_name_1" {
  type        = string
  description = "(Optional)The SKU of the Virtual Hub. Possible values are Basic and Standard`."
}

variable "vpn_ip_address_1" {
  type        = string
  description = "(Optional)The SKU of the Virtual Hub. Possible values are Basic and Standard`."
}

variable "vpn_link_name_2" {
  type        = string
  description = "(Optional)The SKU of the Virtual Hub. Possible values are Basic and Standard`."
}

variable "vpn_ip_address_2" {
  type        = string
  description = "(Optional)The SKU of the Virtual Hub. Possible values are Basic and Standard`."
}
