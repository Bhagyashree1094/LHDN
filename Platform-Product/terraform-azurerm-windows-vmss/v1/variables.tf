...
#--------------------------------
# - Windows VMSS Required Variables
#--------------------------------
variable "sku" {
  type        = string
...
variable "admin_password" {
  type        = string
  description = "(Required) The password of the windows vmss."
  sensitive   = true
}
...
#--------------------------------
# - Windows VMSS Optional Variables
#--------------------------------
variable "instances" {
...
variable "edge_zone" {
  type        = string
  description = "(Optional) Specifies the Edge Zone within the Azure Region where this Windows Virtual Machine Scale Set should exist. Changing this forces a new Windows Virtual Machine Scale Set to be created."
  default     = null
}
...
variable "zones" {
  type        = list(string)
  description = "(Optional) Specifies a list of Availability Zones in which this Windows Virtual Machine Scale Set should be located. Changing this forces a new Windows Virtual Machine Scale Set to be created."
  default     = null
}
...
variable "platform_fault_domain_count" {
  type        = number
  description = "(Optional) Specifies the number of fault domains that are used by this Windows Virtual Machine Scale Set. Changing this forces a new resource to be created."
  default     = 0
}
