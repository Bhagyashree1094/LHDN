...
variable "billing_account_name" {
  type        = string
  description = "(Required) Name of the Billing account name in which to create the Subscription."
}

variable "enrollment_account_name" {
  type        = string
  description = "(Required) Name of the Enrollment account name in which to create the Subscription."
}
...
variable "subscription_name" {
  type = string
  description = "value of the subscription name"
}
