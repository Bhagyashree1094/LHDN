...
variable "au" {
  type        = string
  description = "(Required) BBLAccounting Unit (AU) code. Example: `0233985`. <br></br>&#8226; Value of `au` must be of numeric characters."
  validation {
...
variable "owner" {
  type        = string
  description = "(Required) BBLtechnology owner group."
}
