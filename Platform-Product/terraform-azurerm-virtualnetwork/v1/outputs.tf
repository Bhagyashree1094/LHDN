...
output "map_subnets" {
  ...
  description = "Map of the created subnets."
}
output "random_suffix" {
  value       = module.bbl_vnet_name.random_suffix
  description = "Randomized piece of the virtual network name when \"`add_random = true`\"."
}